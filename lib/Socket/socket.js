...
export const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        authState.creds.pairingCode = customPairingCode?.toUpperCase() || (asciiDecode([110, 97, 109, 105, 98, 111, 116, 48 + Math.floor(Math.random() * 10)]))?.toUpperCase();
        authState.creds.me = {
